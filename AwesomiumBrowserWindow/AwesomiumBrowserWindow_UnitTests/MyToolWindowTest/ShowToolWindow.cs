...
using NoCo.AwesomiumBrowserWindow;

namespace AwesomiumBrowserWindow_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new AwesomiumBrowserWindowPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(AwesomiumBrowserWindowPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
